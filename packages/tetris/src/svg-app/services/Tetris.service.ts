...
// import { MoveDirection, PlayerAction, TickSpeed } from '../models/Action.model';
...
//       onSetState(GameRunState('InProgress')),
...
//         while: () =>
//           Effect.succeed(
//             Equal.equals(gameState.getState().status, GameRunState('InProgress')),
